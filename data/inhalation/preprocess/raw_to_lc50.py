...
lc50 = lc50_tmp[(lc50_tmp['Dose descriptor'] == 'LC50') | 
                (lc50_tmp['Dose descriptor'] == 'other: LC50 (vapor / aerosol)') | 
                (lc50_tmp['Dose descriptor'] == 'other: LC50 (vapor)') | 
...
# lc50 = lc50.loc[lc50['inhale type'].dropna().index].reset_index(drop = True)
# lc50['inhale type'].isna().sum()
# lc50['Dose descriptor'].unique()
