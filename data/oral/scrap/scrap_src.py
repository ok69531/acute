...
tg_path = '/html/body/echem-root/div/echem-substance-search-page/echem-substance-search-container/echem-substance-search/form/div/ngb-accordion[1]/div[2]/div[2]/div/echem-property-query-panel/div[2]/div[3]/echem-property-form/form/echem-property-phrase-field[4]/div/div/div/ng-select/div/div'
...
tg423_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[12]'
driver.find_element_by_xpath(tg423_path).click()
time.sleep(0.5)

tg425_path = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[13]'
driver.find_element_by_xpath(tg425_path).click()
time.sleep(0.5)
...
json.dump(result_, open('tg42_035_page_src.json', 'w'))
