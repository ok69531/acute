...
# data = pd.read_excel('tg42_035_ld50.xlsx')
...
# ld50.to_excel('../oral420_wo_smiles.xlsx', header = True, index = False)
ld50.to_excel('../oral42_035_wo_smiles.xlsx', header = True, index = False)
