...
dermal_path = '//*[@id="QU.SE.7.2-acute-toxicity"]/div/div/div[3]/div[3]'
...
tg402_path1 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[9]'
driver.find_element_by_xpath(tg402_path1).click()
time.sleep(0.5)

tg402_path2 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[10]'
driver.find_element_by_xpath(tg402_path2).click()
time.sleep(0.5)
...
json.dump(result_, open('tg402_page_src.json', 'w'))
