...
#%%
df_tmp = pd.read_excel('tg402_raw.xlsx', header = 0)
...
ld50 = ld50[ld50.unit.isin(['mg/kg', 'g/kg', 'g/Kg'])].reset_index(drop = True)
...
val_df.to_excel('tg402_ld50.xlsx', header = True, index = False)
