...
def multiclass_cross_validation(model, x, y, num_val, seed):
    skf = StratifiedShuffleSplit(n_splits = 5, test_size = num_val, random_state = seed)
...
def binary_cross_validation(model, x, y, num_val, seed):
    skf = StratifiedShuffleSplit(n_splits = 5, test_size = num_val, random_state = seed)
    # skf = StratifiedKFold(n_splits = 5, shuffle = True, random_state = seed)
...
def binary_smote_cross_validation(model, x, y, num_val, seed, args):
    skf = StratifiedShuffleSplit(n_splits = 5, test_size = num_val, random_state = seed)
    # skf = StratifiedKFold(n_splits = 5, shuffle = True, random_state = seed)
